	...
	router.on('route:contact', function (contactId){
	  ...
	  contact.fetch({
	    success:function(contact){
	      $("#container").html(contact.get('name'));
	    }
	  })
	})
